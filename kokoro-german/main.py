...
# ====================== CONFIG ======================
MODEL_PATH = os.getenv("KOKORO_ONNX_MODEL", "/data/kokoro-models/kokoro-martin.onnx")
VOICES_PATH = os.getenv("KOKORO_ONNX_VOICES", "/data/kokoro-models/voices-martin.npz")
